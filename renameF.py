...
#rename the function in the form word1_word2_a letter reflecting the function's size_ the number of distinct xref to the function_number of distinct xref from the function
