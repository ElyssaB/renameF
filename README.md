# renameF
This is a little plugin for radare2 that renames all functions that have not been renamed yet with a random sequence of two words from the most 10000 most used words in the english dictionary (e.g., brown_robot, flat_banana, mighty_fox, snow_crumbles..).
